...
# kedro_getting_started documentation build
...
from kedro_getting_started import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_getting_started"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_getting_starteddoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_getting_started.tex",
        "kedro_getting_started Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_getting_started",
        "Project kedro_getting_started codebase.",
        "Data-Science",
    )
]
